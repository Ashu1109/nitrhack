      ...
      <div className=" w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">
            Empowering mental wellness for everyone
          </p>
        </div>
        <div className="mb-8">
          <h2 className="text-4xl font-bold text-gray-800">Introduction</h2>
          <p className=" mt-2 font-semibold rounded-xl text-[#201658] bg-blue-400 p-3">
            Welcome to <span className=" font-extrabold">Hack4Health</span>,
            your companion for mental well-being. Our app is designed to provide
            support, resources, and tools to help you navigate the complexities
            of mental health.
          </p>{" "}
        </div>
        <div className="mb-8">
          <h2 className="text-4xl font-bold text-gray-800">Our Mission</h2>
          <p className=" rounded-xl  font-semibold text-[#201658] bg-blue-400 p-3 mt-2">
            At <span className=" font-extrabold">Hack4Health</span>, our mission
            is to promote mental wellness and empower individuals to take
            control of their mental health journey. We strive to create a safe
            and inclusive space where everyone feels heard, supported, and
            understood.
          </p>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="rounded-xl font-semibold  text-[#201658] bg-blue-400 p-3 mt-2">
            ...
            Reach out to our team at [Contact Email/Phone] for assistance.
          </p>
        </div>
        ...
        <div className="mb-8">
          ...
          <p className="rounded-xl font-semibold  text-[#201658] bg-blue-400 p-3 mt-2">
            Thank you for choosing [App Name] as your mental health companion.
            Together, we can break the stigma surrounding mental health and
