        ...
        <div className='flex justify-center items-center'>
            <div className="flex flex-col items-center justify-center w-[70vw] h-[70vh]">
                ...
                <div className="flex flex-col justify-center items-center">
                    {/* Progress Bar 1 */}
                    <ProgressBar title="Anxiety" percentage={assessmentResults.anxiety} color="bg-blue-500" />

                    {/* Progress Bar 2 */}
                    <ProgressBar title="Depression" percentage={assessmentResults.depression} color="bg-green-500" />

                    {/* Progress Bar 3 */}
                    <ProgressBar title="ADHD" percentage={assessmentResults.adhd} color="bg-orange-500" />
