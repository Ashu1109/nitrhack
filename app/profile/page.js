            ...
            <div className="flex flex-col  pt-1 items-center gap-3">
              <div className="flex justify-between w-full items-center">
                <div className="flex flex-col">
                  ...
                  <span className=" text-gray-400 text-md">Male</span>
                </div>
                <div className="flex flex-col">
                  <h1 className=" text-gray-800 text-xl">Age:</h1>
                  <span className=" text-gray-400 text-md">20 yrs</span>
                </div>
                <div className="flex flex-col">
                  <h1 className=" text-gray-800 text-xl">Semester:</h1>
                  <span className=" text-gray-400 text-md">1st </span>
                </div>
              </div>
              <div className="flex justify-between w-full items-center">
                <div className="flex flex-col">
                  <h1 className=" text-gray-800 text-xl">Last visit</h1>
                  <span className=" text-gray-400 text-md">28:02:2024</span>
                </div>
                <div className="flex flex-col">
                  <h1 className="text-gray-800 text-xl">Next visit</h1>
                  <span className=" text-gray-400 text-md">2:03:2024</span>
                </div>
                <div className="flex flex-col">
                  <h1 className=" text-gray-800 text-xl">Problem:</h1>
                  <span className=" text-gray-400 text-md">Depression </span>
                </div>
              </div>
            </div>
          </div>
